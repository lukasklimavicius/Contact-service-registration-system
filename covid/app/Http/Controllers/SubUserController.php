...
class SubUserController extends Controller
{
    ...
    function add_validation(Request $request)
    {
        ...
        return redirect('sub_user')->with('success', 'New Company Added');
    }
    ...
    function edit_validation(Request $request)
    {
        ...
        return redirect('sub_user')->with('success', 'Company Data Updated');
    ...
    function delete($id)
    {
        ...
        return redirect('sub_user')->with('success', 'Company Data Removed');
    }
}
